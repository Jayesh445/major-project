...
const usersData = [
  { name: 'Rajesh Kumar', email: 'admin@scm.dev', role: 'admin' as const },
  { name: 'Priya Sharma', email: 'priya.wh@scm.dev', role: 'warehouse_manager' as const },
  { name: 'Amit Patel', email: 'amit.wh@scm.dev', role: 'warehouse_manager' as const },
  { name: 'Sneha Reddy', email: 'sneha.wh@scm.dev', role: 'warehouse_manager' as const },
  { name: 'Vikram Singh', email: 'vikram.proc@scm.dev', role: 'procurement_officer' as const },
  { name: 'Ananya Gupta', email: 'ananya.proc@scm.dev', role: 'procurement_officer' as const },
];
...
const warehousesData = [
  {
    ...
    zones: [
      { zoneCode: 'MUM-BLK', type: 'bulk' as const, capacityUnits: 5000, currentLoad: 4200 },
      { zoneCode: 'MUM-FM', type: 'fast_moving' as const, capacityUnits: 4000, currentLoad: 3600 },
      { zoneCode: 'MUM-GEN', type: 'general' as const, capacityUnits: 3000, currentLoad: 2000 },
    ],
  },
  {
    ...
    zones: [
      { zoneCode: 'DEL-FM', type: 'fast_moving' as const, capacityUnits: 4000, currentLoad: 2800 },
      { zoneCode: 'DEL-GEN', type: 'general' as const, capacityUnits: 3000, currentLoad: 1850 },
      { zoneCode: 'DEL-FRG', type: 'fragile' as const, capacityUnits: 2000, currentLoad: 1200 },
    ],
  },
  {
    ...
    zones: [
      { zoneCode: 'BLR-SM', type: 'slow_moving' as const, capacityUnits: 3000, currentLoad: 1200 },
      { zoneCode: 'BLR-GEN', type: 'general' as const, capacityUnits: 3000, currentLoad: 1200 },
      { zoneCode: 'BLR-FM', type: 'fast_moving' as const, capacityUnits: 2000, currentLoad: 800 },
    ],
  },
  {
    ...
    zones: [
      { zoneCode: 'KLK-BLK', type: 'bulk' as const, capacityUnits: 3500, currentLoad: 3100 },
      { zoneCode: 'KLK-GEN', type: 'general' as const, capacityUnits: 3500, currentLoad: 2850 },
    ],
  },
];

const productsData = [
  { sku: 'PEN-BP-001', name: 'Ballpoint Pen Blue (Pack of 10)', category: 'writing_instruments' as const, unit: 'pack' as const, unitPrice: 85, reorderPoint: 150, safetyStock: 60, reorderQty: 500, leadTimeDays: 3 },
  { sku: 'PEN-GEL-002', name: 'Gel Pen Black Premium', category: 'writing_instruments' as const, unit: 'piece' as const, unitPrice: 25, reorderPoint: 200, safetyStock: 80, reorderQty: 1000, leadTimeDays: 4 },
  { sku: 'PPR-A4-001', name: 'A4 Copier Paper 75 GSM', category: 'paper_products' as const, unit: 'ream' as const, unitPrice: 245, reorderPoint: 50, safetyStock: 20, reorderQty: 200, leadTimeDays: 2 },
  { sku: 'PPR-A3-002', name: 'A3 Drawing Paper 120 GSM', category: 'paper_products' as const, unit: 'ream' as const, unitPrice: 420, reorderPoint: 30, safetyStock: 10, reorderQty: 80, leadTimeDays: 5 },
  { sku: 'OFF-STP-001', name: 'Heavy Duty Stapler', category: 'office_supplies' as const, unit: 'piece' as const, unitPrice: 350, reorderPoint: 40, safetyStock: 15, reorderQty: 100, leadTimeDays: 7 },
  { sku: 'OFF-TAPE-002', name: 'Transparent Tape Roll 24mm', category: 'office_supplies' as const, unit: 'piece' as const, unitPrice: 35, reorderPoint: 100, safetyStock: 40, reorderQty: 300, leadTimeDays: 3 },
  { sku: 'ART-MARK-001', name: 'Whiteboard Marker Set (4 Colors)', category: 'art_supplies' as const, unit: 'set' as const, unitPrice: 180, reorderPoint: 60, safetyStock: 25, reorderQty: 200, leadTimeDays: 4 },
  { sku: 'ART-SKTCH-002', name: 'Sketch Pad A4 50 Sheets', category: 'art_supplies' as const, unit: 'piece' as const, unitPrice: 120, reorderPoint: 45, safetyStock: 15, reorderQty: 150, leadTimeDays: 5 },
  { sku: 'FIL-BINDER-001', name: 'Ring Binder A4 2-inch', category: 'filing_storage' as const, unit: 'piece' as const, unitPrice: 150, reorderPoint: 50, safetyStock: 20, reorderQty: 120, leadTimeDays: 6 },
  { sku: 'FIL-FOLDER-002', name: 'Manila File Folder (Pack of 25)', category: 'filing_storage' as const, unit: 'pack' as const, unitPrice: 210, reorderPoint: 40, safetyStock: 15, reorderQty: 100, leadTimeDays: 4 },
  { sku: 'DSK-ORGNZ-001', name: 'Desk Organizer 5-Slot Wooden', category: 'desk_accessories' as const, unit: 'piece' as const, unitPrice: 550, reorderPoint: 25, safetyStock: 10, reorderQty: 60, leadTimeDays: 10 },
  { sku: 'DSK-PAD-002', name: 'Desk Mouse Pad Large', category: 'desk_accessories' as const, unit: 'piece' as const, unitPrice: 199, reorderPoint: 35, safetyStock: 12, reorderQty: 80, leadTimeDays: 5 },
  { sku: 'OFF-CLIP-003', name: 'Binder Clips Assorted (Box of 48)', category: 'office_supplies' as const, unit: 'box' as const, unitPrice: 95, reorderPoint: 80, safetyStock: 30, reorderQty: 250, leadTimeDays: 3 },
  { sku: 'PEN-HGHL-003', name: 'Highlighter Set 6 Colors', category: 'writing_instruments' as const, unit: 'set' as const, unitPrice: 140, reorderPoint: 70, safetyStock: 25, reorderQty: 200, leadTimeDays: 4 },
  { sku: 'PPR-NOTE-003', name: 'Sticky Notes 3x3 inch (Pack of 12)', category: 'paper_products' as const, unit: 'pack' as const, unitPrice: 160, reorderPoint: 60, safetyStock: 20, reorderQty: 180, leadTimeDays: 3 },
];
...
// Demand pattern profiles – each product gets one to create varied forecasting scenarios
type DemandProfile = {
  baseWeekday: number;
  baseWeekend: number;
  trend: 'rising' | 'falling' | 'stable' | 'seasonal';
  volatility: number; // 0-1 scale
  spikeChance: number; // probability of a demand spike on any day
};
 ...
 */
function getDemandForDay(profile: DemandProfile, dayIndex: number, date: Date): number {
...
async function seed() {
  ...
  const users = await User.insertMany(
    usersData.map((u) => ({ ...u, passwordHash, isActive: true }))
  );
  ...
  const poStatuses: Array<{ status: string; triggeredBy: string }> = [
  ...
  for (let i = 0; i < 12; i++) {
    ...
    const lineItems = selectedProducts.map((p) => {
      const qty = randomInt(
        Math.round(p.reorderQty * 0.5),
        Math.round(p.reorderQty * 1.5)
      );
