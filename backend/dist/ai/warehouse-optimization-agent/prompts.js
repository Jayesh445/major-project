...
exports.OPTIMIZATION_PROMPT = exports.ANALYSIS_PROMPT = void 0;
const ANALYSIS_PROMPT = (warehouses, inventoryData) => `
...
${invData.products.slice(0, 10).map((p) => `  - ${p.productName} (${p.sku}): Stock=${p.currentStock}, Reorder Point=${p.reorderPoint}`).join('\n')}
...
`;
exports.ANALYSIS_PROMPT = ANALYSIS_PROMPT;
const OPTIMIZATION_PROMPT = (warehouses, inventoryData, analysis) => `
...
`;
exports.OPTIMIZATION_PROMPT = OPTIMIZATION_PROMPT;
